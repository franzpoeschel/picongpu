...
namespace openPMD
{
    ...
    namespace writeMeta
    {
        ...
        struct OfAllSpecies
        {
            ...
            {
                // assume all boundaries are like the first species for
                // openPMD 1.0.0
    ...
    struct WriteMeta
    {
        ...
        operator()( ThreadParams * threadParams )
        {
            ...
            iteration.setAttribute( "unit_speed", UNIT_SPEED );
            iteration.setAttribute( "unit_time", UNIT_TIME );
            iteration.setAttribute( "unit_mass", UNIT_MASS );
            iteration.setAttribute( "unit_charge", UNIT_CHARGE );
            iteration.setAttribute( "unit_efield", UNIT_EFIELD );
            iteration.setAttribute( "unit_bfield", UNIT_BFIELD );
